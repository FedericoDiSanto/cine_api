...
from peliculas.api.router import router_pelicula
from comentarios.api.router import router_comentario
...
urlpatterns = [
    ...
    path("api/", include(router_pelicula.urls)),
    path("api/", include(router_comentario.urls)),
